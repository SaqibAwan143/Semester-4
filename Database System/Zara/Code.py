...
def add_employee():
    ...
    empl_age  = input('Enter employee age  :')
    empl_salary  = input('Enter Employee salary. :')
    date_of_joining = input('Enter Date of joining :')
    sql = 'insert into empl(empl_id,empl_name,empl_age,empl_salary,date_of_joining) values (%s,%s,%s,%s,%s)'
    Employee_details=(empl_id,empl_name,empl_age,empl_salary,date_of_joining)
